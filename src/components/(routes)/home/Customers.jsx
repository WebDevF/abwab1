...
export default function Customers() {
  ...
  return (
    <div className="py-10 px-6 bg-[#E7ECF9B2] ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 max-w-10xl 2xl:max-w-10xl mb-8 ">
        {customers.slice(0, 2).map((item, index) => (
          <Card key={index} item={item} />
        ))}
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-10xl 2xl:max-w-10xl">
